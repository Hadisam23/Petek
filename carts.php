...
<html lang="en" data-theme="light">
    ...
    <body data-spy="scroll" data-target=".navbar" data-offset="68">
        <div class="container my-3">
            ...
            <img id="regs" src="https://image.flaticon.com/icons/svg/1069/1069102.svg" />

            <select id="mySelect" class="mdb-select md-form m-5" onchange="AddListToSelect()">
                <option value="" disabled selected>Select from my carts</option>
