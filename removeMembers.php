...
<html lang="en" data-theme="light">
    ...
    <body data-spy="scroll" data-target=".navbar" data-offset="68">
        ...
        <div class="container mt-5 ">
            <br>
            <h1 class="headF">Remove Members From My Family</h1>
            ...
            <table style="background-color:rgb(167, 224, 247)" class="table" id="remMembers">
                <thead>
                    <tr>
                ...
                <tr v-else v-for="item in items">
                    <td>{{item.name}}</td>
                    <td>
                        <a :href="'deleteMem.php?member=' +item.name" >Delete</a> 
                    </td>
                </tr>
                </tbody>
            </table>
